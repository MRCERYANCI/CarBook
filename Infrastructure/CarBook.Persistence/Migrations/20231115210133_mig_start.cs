    ...
    public partial class mig_start : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CardPricingId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CardPricings", x => x.CardPricingId);
                    table.ForeignKey(
                        name: "FK_CardPricings_Cars_CarId",
                        column: x => x.CarId,
                        principalTable: "Cars",
                        principalColumn: "CarId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CardPricings_Pricings_PricingId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CardPricings_CarId",
                table: "CardPricings",
                column: "CarId");

            migrationBuilder.CreateIndex(
                name: "IX_CardPricings_PricingId",
                table: "CardPricings",
                column: "PricingId");
