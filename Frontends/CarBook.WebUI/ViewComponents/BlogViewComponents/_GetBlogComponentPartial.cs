...
{
    public class _GetBlogComponentPartial:ViewComponent
    {
        private readonly IHttpClientFactory _httpClientFactory;

        public _GetBlogComponentPartial(IHttpClientFactory httpClientFactory)
        {
        ...
        public async Task<IViewComponentResult> InvokeAsync()
        {
            ...
            var responsemessage = await client.GetAsync("https://localhost:7125/api/Blog/GetLastBlogsWithAuthors");
